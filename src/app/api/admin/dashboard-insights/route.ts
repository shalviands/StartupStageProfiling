...
export async function POST(
  ...
  const cohortStats = {
    ...
    avg_p1: (scores.reduce((a, b) => a + b.p1, 0) / scores.length).toFixed(1),
    avg_p2: (scores.reduce((a, b) => a + b.p2, 0) / scores.length).toFixed(1),
    avg_p3: (scores.reduce((a, b) => a + b.p3, 0) / scores.length).toFixed(1),
    avg_p4: (scores.reduce((a, b) => a + b.p4, 0) / scores.length).toFixed(1),
    avg_p5: (scores.reduce((a, b) => a + b.p5, 0) / scores.length).toFixed(1),
    avg_p6: (scores.reduce((a, b) => a + b.p6, 0) / scores.length).toFixed(1),
    avg_p7: (scores.reduce((a, b) => a + b.p7, 0) / scores.length).toFixed(1),
    avg_p8: (scores.reduce((a, b) => a + b.p8, 0) / scores.length).toFixed(1),
    avg_p9: (scores.reduce((a, b) => a + b.p9, 0) / scores.length).toFixed(1),
    sectors,
