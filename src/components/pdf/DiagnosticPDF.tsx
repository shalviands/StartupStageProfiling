  ...
  return (
    <Document>
      <Page size="A4" style={s.page}>
        {/* Header */}
        <View style={s.header}>
          <Text style={s.title}>{team.startupName || 'Startup Brief'}</Text>
          <Text style={s.subtitle}>Diagnosis Report • InUnity Startup Profiler</Text>
        </View>

        {/* Diagnostic Scores */}
        <View style={s.section}>
          <Text style={s.sectionTitle}>Diagnostic Scores</Text>
          <View style={s.grid}>
        ...
        {/* Diagnosis */}
        <View style={s.section}>
          <Text style={s.sectionTitle}>Incubation Diagnosis</Text>
          <View style={s.row}>
        ...
        {/* Footer */}
        <View style={s.footer}>
          <Text style={s.footerText}>Generated by InUnity Profiler</Text>
