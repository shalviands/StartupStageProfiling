...
export function mapDbToFrontend(row: Record<string, any>): TeamProfile {
  return {
    id:                         row.id                               ?? '',
...
export function mapFrontendToDb(team: Partial<TeamProfile>): Record<string, any> {
  ...
  if (team.competitorDetails      !== undefined) db.competitor_details         = team.competitorDetails
